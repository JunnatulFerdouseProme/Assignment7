    ...
    public class CustomerRepository
    {
        public bool Add(string name, string contact, string address)
        {
            ...
            try
            {
                ...
                string commandString = @"INSERT INTO Customer (Name, Contact,Address) Values ('" + name + "', '" + contact + "','"+address+"')";
        ...
        public bool Update(string name, string contact,string address, int id)
        {
            try
            {
                ...
                string commandString = @"UPDATE Customer SET Name =  '" + name + "' , Contact ='" + contact + "',Address='"+ address +"'  WHERE ID = " + id + "";
                SqlCommand sqlCommand = new SqlCommand(commandString, sqlConnection);
